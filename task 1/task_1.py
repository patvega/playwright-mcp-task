...
def main():
    with sync_playwright() as p:
        ...
        try:
            ...
            print('Timeout: Amazon page took too long to load')
            browser.close()
            return
        ...
        while True:
            ...
            if next_button.count() > 0 and next_button.is_enabled():
                ...
                print('No more pages available - no blue shirts found under $5')
                browser.close()
                return
       ...
       # Taking a screenshot as evidence of ending up on the product's page
        ...
        page.screenshot(path='shirt_selected.png')
        ...
        page.screenshot(path='cart_confirm.png')
        browser.close()
